...
function createData(promotion, product, status,discount,price, action) {
    return { promotion, product, status,discount,price, action };
}
...
const rows = [
    createData('India', 'IN', 1324171354, 3287263,21312323,
        <div>
