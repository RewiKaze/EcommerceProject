  ...
  return (
    <React.Fragment>
      ...
      <div className="filter-bar">
        <Button >
          <SingleBedIcon style={{ fontSize: '2.5rem' }}></SingleBedIcon>
          <span>Bedroom</span>
        </Button>
        <Button >
          <BathtubIcon style={{ fontSize: '2.5rem' }}></BathtubIcon>
          <span>Bathroom</span>
        </Button>
        <Button >
          <KitchenIcon style={{ fontSize: '2.5rem' }}></KitchenIcon>
          <span>Kitchen</span>
        </Button>
        <Button >
          <WeekendIcon style={{ fontSize: '2.5rem' }}></WeekendIcon>
